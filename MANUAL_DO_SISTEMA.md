...
> ⚠️ **Importante**: O **COLABORADOR** (simples) **não acessa a plataforma** — ele não possui login e senha. É apenas um registro no sistema para controle de alocação. Por isso, não há permissões de sistema para ele.
